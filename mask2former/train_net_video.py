...
from train_net import RANKSEGEvaluator
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if 'vspw' in cfg.DATASETS.TRAIN[0]:
            return VSPWEvaluator(
                dataset_name,
                distributed=True,
    ...
    def build_train_loader(cls, cfg):
        ...
        if 'vspw' in cfg.DATASETS.TRAIN[0]:
            mapper = VSPWDatasetMapper(cfg, is_train=True)
        else:
    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            for module_param_name, value in module.named_parameters(
                ...
                if "ml_head" in module_name:
                    hyperparams["lr"] = hyperparams[
                    "lr"] * cfg.SOLVER.MLHEAD_MULTIPLIER
                ...
                if isinstance(module, torch.nn.Embedding) or "cls_emb" in module_name:
                    hyperparams["weight_decay"] = weight_decay_embed
                params.append({"params": [value], **hyperparams})
                print(module_name, " weight_decay:", hyperparams["weight_decay"], " lr:", hyperparams["lr"])
